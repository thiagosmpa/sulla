...
CREATE TABLE "Session2" (
    ...
    CONSTRAINT "Session2_pkey" PRIMARY KEY ("sessionId")
);
...
CREATE TABLE "Message2" (
    ...
    CONSTRAINT "Message2_pkey" PRIMARY KEY ("pkId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Session2_sessionId_key" ON "Session2"("sessionId");

-- CreateIndex
CREATE UNIQUE INDEX "Session2_name_key" ON "Session2"("name");
...
-- AddForeignKey
ALTER TABLE "Chat2" ADD CONSTRAINT "Chat2_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "Session2"("sessionId") ON DELETE RESTRICT ON UPDATE CASCADE;
